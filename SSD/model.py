...
class SSD(nn.Module):
    ...
    def forward(self, x):
        ...
        if self.phase == "inference":
            return self.detect.apply(21, 0, 200, 0.01, 0.45,output[0], output[1], output[2])
        else:
            return output
...
class Detect(Function):
    ...
    def forward(self,num_classes, bkg_label, top_k, conf_thresh,nms_thresh, loc_data, conf_data, dbox_list):
        ...
        conf_data = nn.Softmax(dim=-1)(conf_data) 
